...
namespace AdventOfCode2022.Tests.UnitTests
{
    ...
    public class Day21SolverTests
    {
        ...
        {
            TestUtilities.SolvePart1CustomTest(new Day21Solver(input), expectedResult);
        }
        ...
        {
            TestUtilities.SolvePart2CustomTest(new Day21Solver(input), expectedResult);
        }
