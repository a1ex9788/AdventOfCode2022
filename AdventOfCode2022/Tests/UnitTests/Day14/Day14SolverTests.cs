...
namespace AdventOfCode2022.Tests.UnitTests.Day14
{
    [TestClass]
    public class Day14SolverTests
    {
        ...
        {
            (SolverFolder, TestsFolder) = TestUtilities.GetFolders<Day14Solver>();
        ...
        public void SolvePart1CustomTest(string exampleInputName, string expectedResult)
        {
            TestUtilities.SolvePart1CustomTest(
                input => new Day14Solver(input), TestsFolder!, exampleInputName, expectedResult);
        }
