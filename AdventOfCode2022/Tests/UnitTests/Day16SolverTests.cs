...
namespace AdventOfCode2022.Tests.UnitTests
{
    ...
    public class Day16SolverTests
    {
        ...
        {
            TestUtilities.SolvePart1CustomTest(new Day16Solver(input), expectedResult);
        }
        ...
        {
            TestUtilities.SolvePart2CustomTest(new Day16Solver(input), expectedResult);
        }
