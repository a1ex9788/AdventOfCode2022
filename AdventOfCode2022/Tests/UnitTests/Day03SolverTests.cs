...
namespace AdventOfCode2022.Tests.UnitTests
{
    ...
    public class Day03SolverTests
    {
        ...
        {
            string subfolder = typeof(Day03Solver).Name.Replace("Solver", string.Empty);
        ...
        {
            TestUtilities.SolvePart1CustomTest(new Day03Solver(input), expectedResult);
        }
        ...
        {
            TestUtilities.SolvePart2CustomTest(new Day03Solver(input), expectedResult);
        }
