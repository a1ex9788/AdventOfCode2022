...
namespace AdventOfCode2022.Tests.UnitTests
{
    ...
    public class Day18SolverTests
    {
        ...
        {
            TestUtilities.SolvePart1CustomTest(new Day18Solver(input), expectedResult);
        }
        ...
        {
            TestUtilities.SolvePart2CustomTest(new Day18Solver(input), expectedResult);
        }
