...
namespace AdventOfCode2022.Tests.UnitTests
{
    ...
    public class Day20SolverTests
    {
        ...
        {
            string subfolder = typeof(Day20Solver).Name.Replace("Solver", string.Empty);
        ...
        {
            TestUtilities.SolvePart1CustomTest(new Day20Solver(input), expectedResult);
        }
        ...
        {
            TestUtilities.SolvePart2CustomTest(new Day20Solver(input), expectedResult);
        }
