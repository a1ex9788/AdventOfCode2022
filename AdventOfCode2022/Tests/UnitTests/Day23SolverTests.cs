...
namespace AdventOfCode2022.Tests.UnitTests
{
    ...
    public class Day23SolverTests
    {
        ...
        {
            string subfolder = typeof(Day23Solver).Name.Replace("Solver", string.Empty);
        ...
        {
            TestUtilities.SolvePart1CustomTest(new Day23Solver(input), expectedResult);
        }
        ...
        {
            TestUtilities.SolvePart2CustomTest(new Day23Solver(input), expectedResult);
        }
