...
namespace AdventOfCode2022.Tests.UnitTests.Day21
{
    [TestClass]
    public class Day21SolverTests
    {
        ...
        {
            (SolverFolder, TestsFolder) = TestUtilities.GetFolders<Day21Solver>();
        ...
        public void SolvePart1CustomTest(string exampleInputName, long expectedResult)
        {
            TestUtilities.SolvePart1CustomTest(
                input => new Day21Solver(input), TestsFolder!, exampleInputName, expectedResult);
        }
