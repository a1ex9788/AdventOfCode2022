...
namespace AdventOfCode2022.Tests.UnitTests.Day24
{
    [TestClass]
    public class Day24SolverTests
    {
        ...
        {
            (SolverFolder, TestsFolder) = TestUtilities.GetFolders<Day24Solver>();
        ...
        public void SolvePart1CustomTest(string exampleInputName, string expectedResult)
        {
            TestUtilities.SolvePart1CustomTest(
                input => new Day24Solver(input), TestsFolder!, exampleInputName, expectedResult);
        }
