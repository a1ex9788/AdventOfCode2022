...
namespace AdventOfCode2022.Tests.UnitTests
{
    ...
    public class Day17SolverTests
    {
        ...
        {
            string subfolder = typeof(Day17Solver).Name.Replace("Solver", string.Empty);
        ...
        {
            TestUtilities.SolvePart1CustomTest(new Day17Solver(input), expectedResult);
        }
        ...
        {
            TestUtilities.SolvePart2CustomTest(new Day17Solver(input), expectedResult);
        }
