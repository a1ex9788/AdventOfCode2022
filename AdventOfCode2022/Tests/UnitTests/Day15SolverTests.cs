...
namespace AdventOfCode2022.Tests.UnitTests
{
    ...
    public class Day15SolverTests
    {
        ...
        {
            TestUtilities.SolvePart1CustomTest(new Day15Solver(input), expectedResult);
        }
        ...
        {
            TestUtilities.SolvePart2CustomTest(new Day15Solver(input), expectedResult);
        }
