...
namespace AdventOfCode2022.Tests.UnitTests
{
    ...
    public class Day24SolverTests
    {
        ...
        {
            TestUtilities.SolvePart1CustomTest(new Day24Solver(input), expectedResult);
        }
        ...
        {
            TestUtilities.SolvePart2CustomTest(new Day24Solver(input), expectedResult);
        }
