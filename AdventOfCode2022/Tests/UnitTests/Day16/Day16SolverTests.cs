...
namespace AdventOfCode2022.Tests.UnitTests.Day16
{
    [TestClass]
    public class Day16SolverTests
    {
        ...
        {
            (SolverFolder, TestsFolder) = TestUtilities.GetFolders<Day16Solver>();
        ...
        public void SolvePart1CustomTest(string exampleInputName, string expectedResult)
        {
            TestUtilities.SolvePart1CustomTest(
                input => new Day16Solver(input), TestsFolder!, exampleInputName, expectedResult);
        }
