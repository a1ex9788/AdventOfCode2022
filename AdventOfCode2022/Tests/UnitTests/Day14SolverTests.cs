...
namespace AdventOfCode2022.Tests.UnitTests
{
    ...
    public class Day14SolverTests
    {
        ...
        {
            TestUtilities.SolvePart1CustomTest(new Day14Solver(input), expectedResult);
        }
        ...
        {
            TestUtilities.SolvePart2CustomTest(new Day14Solver(input), expectedResult);
        }
