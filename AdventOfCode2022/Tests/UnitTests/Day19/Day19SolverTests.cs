...
namespace AdventOfCode2022.Tests.UnitTests.Day19
{
    [TestClass]
    public class Day19SolverTests
    {
        ...
        {
            (SolverFolder, TestsFolder) = TestUtilities.GetFolders<Day19Solver>();
        ...
        public void SolvePart1CustomTest(string exampleInputName, string expectedResult)
        {
            TestUtilities.SolvePart1CustomTest(
                input => new Day19Solver(input), TestsFolder!, exampleInputName, expectedResult);
        }
