...
namespace AdventOfCode2022.Tests.UnitTests
{
    ...
    public class Day12SolverTests
    {
        ...
        {
            TestUtilities.SolvePart1CustomTest(new Day12Solver(input), expectedResult);
        }
        ...
        {
            TestUtilities.SolvePart2CustomTest(new Day12Solver(input), expectedResult);
        }
