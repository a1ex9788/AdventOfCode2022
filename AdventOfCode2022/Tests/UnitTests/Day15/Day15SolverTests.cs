...
namespace AdventOfCode2022.Tests.UnitTests.Day15
{
    [TestClass]
    public class Day15SolverTests
    {
        ...
        {
            (SolverFolder, TestsFolder) = TestUtilities.GetFolders<Day15Solver>();
        ...
        public void SolvePart1CustomTest(string exampleInputName, long expectedResult)
        {
            TestUtilities.SolvePart1CustomTest(
                input => new Day15Solver(input), TestsFolder!, exampleInputName, expectedResult);
        }
