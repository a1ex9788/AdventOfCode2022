...
namespace AdventOfCode2022.Tests.UnitTests
{
    ...
    public class Day02SolverTests
    {
        ...
        {
            string subfolder = typeof(Day02Solver).Name.Replace("Solver", string.Empty);
        ...
        {
            TestUtilities.SolvePart1CustomTest(new Day02Solver(input), expectedResult);
        }
        ...
        {
            TestUtilities.SolvePart2CustomTest(new Day02Solver(input), expectedResult);
        }
