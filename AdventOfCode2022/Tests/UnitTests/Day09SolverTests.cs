...
namespace AdventOfCode2022.Tests.UnitTests
{
    ...
    public class Day09SolverTests
    {
        ...
        {
            string subfolder = typeof(Day09Solver).Name.Replace("Solver", string.Empty);
        ...
        {
            TestUtilities.SolvePart1CustomTest(new Day09Solver(input), expectedResult);
        }
        ...
        {
            TestUtilities.SolvePart2CustomTest(new Day09Solver(input), expectedResult);
        }
