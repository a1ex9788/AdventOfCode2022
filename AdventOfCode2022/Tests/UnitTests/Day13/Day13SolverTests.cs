...
namespace AdventOfCode2022.Tests.UnitTests.Day13
{
    [TestClass]
    public class Day13SolverTests
    {
        ...
        {
            (SolverFolder, TestsFolder) = TestUtilities.GetFolders<Day13Solver>();
        ...
        public void SolvePart1CustomTest(string exampleInputName, long expectedResult)
        {
            TestUtilities.SolvePart1CustomTest(
                input => new Day13Solver(input), TestsFolder!, exampleInputName, expectedResult);
        }
