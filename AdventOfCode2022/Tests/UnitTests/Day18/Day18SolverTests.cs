...
namespace AdventOfCode2022.Tests.UnitTests.Day18
{
    [TestClass]
    public class Day18SolverTests
    {
        ...
        {
            (SolverFolder, TestsFolder) = TestUtilities.GetFolders<Day18Solver>();
        ...
        public void SolvePart1CustomTest(string exampleInputName, long expectedResult)
        {
            TestUtilities.SolvePart1CustomTest(
                input => new Day18Solver(input), TestsFolder!, exampleInputName, expectedResult);
        }
