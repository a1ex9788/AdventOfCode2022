...
namespace AdventOfCode2022.Tests.UnitTests
{
    ...
    public class Day22SolverTests
    {
        ...
        {
            string subfolder = typeof(Day22Solver).Name.Replace("Solver", string.Empty);
        ...
        {
            TestUtilities.SolvePart1CustomTest(new Day22Solver(input), expectedResult);
        }
        ...
        {
            TestUtilities.SolvePart2CustomTest(new Day22Solver(input), expectedResult);
        }
