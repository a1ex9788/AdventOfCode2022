...
namespace AdventOfCode2022.Tests.UnitTests
{
    ...
    public class Day06SolverTests
    {
        ...
        {
            string subfolder = typeof(Day06Solver).Name.Replace("Solver", string.Empty);
        ...
        {
            TestUtilities.SolvePart1CustomTest(new Day06Solver(input), expectedResult);
        }
        ...
        {
            TestUtilities.SolvePart2CustomTest(new Day06Solver(input), expectedResult);
        }
