...
namespace AdventOfCode2022.Tests.UnitTests.Day12
{
    [TestClass]
    public class Day12SolverTests
    {
        ...
        {
            (SolverFolder, TestsFolder) = TestUtilities.GetFolders<Day12Solver>();
        ...
        public void SolvePart1CustomTest(string exampleInputName, long expectedResult)
        {
            TestUtilities.SolvePart1CustomTest(
                input => new Day12Solver(input), TestsFolder!, exampleInputName, expectedResult);
        }
